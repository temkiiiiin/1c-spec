...
* Структуры требуемых отчетов
  * Задолженность покупателей
        ...
        --------------------------------------------------
        |   Кексоед       |                   |   100    |
        |   Кексоед       |   Основной        |   100    |
        |   Тортоед       |                   |   1500   |
        |   Тортоед       |   Дополнительный  |   1500   |
...
При проведении расходной накладной по регистру `Управленческий` контроль остатков не требуется, значит не требуется и делать какие-либо блокировки по нему. Для формирования движений воспользуемся конструктором движений. Изменения в обработке проведения:
